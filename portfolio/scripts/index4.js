...
// Ecrire une fonction qui prend en paramètre une personne et qui retourne [firstname] à une IMC de [IMC]
function getPersonWithBmi(pers)
{
    const bmiResult = bmi(pers)
    return `${pers.firstname} à un IMC de ${bmiPers}`
}